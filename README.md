...
Прокет разрабатывался как межплатформенное!
 приложение для проведения онлайн конференций с эффектом присутствия с дальнейшим переносом на VR, но был заброшен на начальном этапе разработки.
